...
$(document).ready(function(){ 
  $("#search-radio-choice-1").click(function(){
    showBids("1");
    window.location.replace("#iteminfo");
  });
...
// 	Document.getElementById("login_button").innerHTML = "<button onclick = FB.login()>click me to login in</button>";
    $("#login_button").trigger ("create");
...
<div data-role="page" id="frontpage">
	...
	<div id = "login_button" class = "fb-login-button" data-autologoutlink="true" data-show-faces="true" data-size="large" data-max-rows="4">
  	</div>
  </div>
</div><!-- /page one -->
...
<div data-role="page" id="profilepage">
	...
	<fb:login-button autologoutlink="true" size="large" max-rows="4"></fb:login-button>
